    ...
    <>
      ...
      <div style={{ maxWidth: 800, margin: "2rem auto", padding: "2rem" }}>
        ...
        <p>
          ...
          dados pessoais com terceiros sem sua autorização, exceto quando
          exigido por lei.
        </p>
        <ul>
          ...
          <li>
            Utilizamos cookies apenas para melhorar sua experiência de
            navegação.
          </li>
        </ul>

        <p>
          Para dúvidas, entre em contato pelo e-mail de suporte informado no
          site.
        </p>
      </div>
    </>
